...
export default class CalculatorListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by CalculatorParser#Asignar.
	enterAsignar(ctx) {
	}

	// Exit a parse tree produced by CalculatorParser#Asignar.
	exitAsignar(ctx) {
	}
	...
	// Enter a parse tree produced by CalculatorParser#Operacion.
	enterOperacion(ctx) {
	}

	// Exit a parse tree produced by CalculatorParser#Operacion.
	exitOperacion(ctx) {
	}


	// Enter a parse tree produced by CalculatorParser#Numero.
	enterNumero(ctx) {
	}

	// Exit a parse tree produced by CalculatorParser#Numero.
	exitNumero(ctx) {
	}
