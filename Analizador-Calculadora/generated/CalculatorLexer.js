...
export default class CalculatorLexer extends antlr4.Lexer {
	...
	static symbolicNames = [ null, "PRINT", "IGUAL", "PUNTO_COMA", "PAR_ABRE", 
                          ...
                          "ID", "NUMERO", "WS" ];
	static ruleNames = [ "PRINT", "IGUAL", "PUNTO_COMA", "PAR_ABRE", "PAR_CIERRA", 
                      "MULT", "DIV", "SUMA", "RESTA", "ID", "NUMERO", "WS" ];
...
CalculatorLexer.IGUAL = 2;
CalculatorLexer.PUNTO_COMA = 3;
CalculatorLexer.PAR_ABRE = 4;
CalculatorLexer.PAR_CIERRA = 5;
CalculatorLexer.MULT = 6;
CalculatorLexer.DIV = 7;
CalculatorLexer.SUMA = 8;
CalculatorLexer.RESTA = 9;
